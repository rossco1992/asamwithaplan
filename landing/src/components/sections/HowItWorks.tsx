  ...
  const steps = [
    {
      ...
      desc: "You'll tell us your date, location, and guest count estimate — that's all we'll need to generate a master timeline."
    },
    {
      number: "02",
      title: "Follow the plan",
      desc: "Each week, you'll get exactly what needs to be done. No massive checklists, just the next right step."
    },
    {
      number: "03",
      title: "Forward the emails",
      desc: "When vendors send contracts or quotes, you'll forward them to your A Sam with a plan address, and we'll extract the data."
    },
    {
      number: "04",
