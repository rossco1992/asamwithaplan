...
export default function SignUpScreen() {
  ...
  const handleVerify = async () => {
    ...
    if (signUp.status === 'complete') {
      await signUp.finalize({
        navigate: ({ decorateUrl }) => { router.replace('/'); },
      });
    }
  };
      ...
      <ScrollView style={s.container} contentContainerStyle={s.content} keyboardShouldPersistTaps="handled">
        ...
        >
          {isLoading
            ...
            : <Text style={s.primaryButtonText}>Verify email</Text>
          }
        </Pressable>
        <Pressable onPress={() => signUp.verifications.sendEmailCode()} style={s.textAction}>
  ...
  return (
    <ScrollView style={s.container} contentContainerStyle={s.content} keyboardShouldPersistTaps="handled">
      ...
      <Text style={s.subheading}>Start planning your perfect wedding</Text>
      ...
      <View style={s.footer}>
        ...
        <Link href="/(auth)/sign-in" asChild>
          <Pressable><Text style={s.footerLink}> Sign in</Text></Pressable>
        </Link>
      </View>
